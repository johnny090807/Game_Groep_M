...
public class Board extends JPanel {
    ...
    public void startLevel(int numberLevel){
        ...
        // Zet de muren op de plekken waar het in het level het aangeeft
        ...
        // Zet de barricades op de plekken waar het in het level het aangeeft
        ...
        // Zet de sleutels op de plekken waar het in het level het aangeeft
        ...
        // Zet de speler op de plek waar het aangeeft in de variabele
        squares[speler.getPosition().x][speler.getPosition().y].setBoardObject(speler);

        // Zet het einde op de plek waar het aangeeft in de variabele
